...
chrome.extension.onMessage.addListener(function(request, sender, f_callback){
	...
	if(tabidClaimFreeDGB.contains(sender.tab.id)){	//если во вкладке другой адрес
		if(request.src != 'claimfreecoins.io' && request.src != 's1.coinmarketwaves.com'){
			...
			if(Programms[indexPrClaimFreeDGB].alreadytrue == true){
				Programms[indexPrClaimFreeDGB].startintervalDOGE = Programms[indexPrClaimFreeDGB].intervalDOGE - second_not_pink_vnut;
			}
