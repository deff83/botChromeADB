...
chrome.extension.onMessage.addListener(function(request, sender, f_callback){
	...
	if(tabidOurBitco30.contains(sender.tab.id)){	//если во вкладке другой адрес
		if(request.src != 'ourbitco.in'){
			...
			if(Programms[indexPrOurBitco30].alreadytrue == true){
				Programms[indexPrOurBitco30].startintervalDOGE = Programms[indexPrOurBitco30].intervalDOGE - second_not_pink_vnut;
			}
