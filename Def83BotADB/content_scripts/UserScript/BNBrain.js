...
try{
	...
	//writeField("ClassName", "pass-input", 0, "0704galaxArt")
	 ...
	 //document.getElementsByName('gateway').value = elem.getAttribute('data-select');
/*
	var elem = document.getElementsByName('gateway');
	...
	*/
	...
	//hideDiv("ClassName", "form-group text-center", -1);
	...
	*/
	...
	drawDIVUser('1', "clickButton('Id', 'claim-button', 0);");
