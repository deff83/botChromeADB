...
try{
	...
	hideDiv("ClassName", "col-12 col-sm-6 col-lg-3 mb-3", -1);
	hideDiv("ClassName", "col-6 col-md-2 col-lg-3 order-md-1 p-0 left-ads", -1);
	hideDiv("ClassName", "chatbro_chat chatbro_movable_chat chatbro_opacity", -1);
	hideDiv("ClassName", "row pb-3", -1);
	hideDiv("ClassName", "row px-4", -1);
	hideDiv("ClassName", "top-bar sticky-top", -1);
