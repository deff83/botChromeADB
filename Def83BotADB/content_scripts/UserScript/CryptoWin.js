...
try{
	...
	//writeField("TagName", "input", 0, "16oe4cdMcvNTXscpJmaycnMeH6FUJhDjf7")
	//writeField("ClassName", "pass-input", 0, "0704galaxArt")
	clickButton("ClassName", "btn btn-block btn-click btn-lg", 0);
	...
	//hideDiv("TagName", "p", -1);
	//hideDiv("TagName", "table", 0);
	//hideDiv("TagName", "iframe", -1);
	//alert(Exc);
	//window.scroll(0,550);
