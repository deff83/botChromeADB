...
try{
	...
	hideDiv("ClassName", "col-md-6 col-xl-6 mb-2 mb-xl-6", -1);
	hideDiv("ClassName", "col-md-6 col-xl-6 mb-1 mb-xl-6", -1);
	hideDiv("ClassName", "alert-warning align-middle text-center noty pt-1 pb-1", -1);
	hideDiv("ClassName", "col-md-6 mt-2 mb-2 text-center mx-auto align-items-center", -1);
	hideDiv("ClassName", "col-md-12 mt-2 mb-2 text-center mx-auto align-items-center", -1);
