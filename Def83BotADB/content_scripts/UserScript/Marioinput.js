...
try{
	...
	writeField("Name", "form_user", 0, "waiss")
	writeField("Name", "form_pwd", 0, "0704galaxArt")
	writeField("Name", "form_pinn", 0, "2019")
	//hideDiv("ClassName", "col text-right text-white mt-5 order-sm-first order-last", -1);
	clickButton("ClassName", "button medium white", 0);
