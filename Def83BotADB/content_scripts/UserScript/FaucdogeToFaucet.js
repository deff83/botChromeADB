//скрипт подключаемый
try{
	setURL('https://faucet-dogecoin.com/faucet');
	//setTimeout(function() {	
	
	/*
	writeField("Name", "user", 0, "waiss2021")
	writeField("Name", "pass", 0, "aWAISS12092021galsla")
	//writeField("ClassName", "pass-input", 0, "0704galaxArt")
	clickButton("ClassName", "btn btn-primary button", 0);
	//}, 2000);
	...
	setTimeout(function() {	
	clickButton("ClassName", "btn btn-success", 0);
	}, 2000);
	...
	hideDiv("Id", "skrit", -1);*/
/*
	drawDIVUser('1', "clickButton('ClassName', 'btn btn-success', 0);");
	*/
