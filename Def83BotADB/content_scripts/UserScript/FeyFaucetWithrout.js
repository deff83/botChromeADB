...
try{
	...
	setTimeout(function() {	
		...
		clickButton("ClassName", "btn-one bg-dark btn-block mb-2 mr-2", 0);
	...
	setTimeout(function() {	
		...
		setURL('https://feyorra.top/faucet')
	}, 5000);
	...
	drawDIVUser('1', "document.location.href = 'https://feyorra.top/account';");
