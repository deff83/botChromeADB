...
try{
	...
	/*
	setTimeout(function() {
		clickButton('ClassName', 'btn shadow-hover btn-lg btn-gradient-03 next-button ripples', 0);
	}, 12000);
	...
	drawDIVUser('1', "clickButton('ClassName', 'btn shadow-hover btn-lg btn-gradient-03 next-button ripples', 0); location.reload();");
